...
export async function handleMediaFire(url) {
...
export async function handleVehicleRC(rc) {
    const startTime = Date.now();
    try {
...
export async function handleGSTLookup(gstNumber) {
    const startTime = Date.now();
    try {
...
export async function handlePhoneInfo(number, type = "pakistan") {
    const startTime = Date.now();
    try {
        let apiUrl = "";
...
export async function handleMACLookup(mac) {
    const startTime = Date.now();
    try {
...
export async function handleTeraBox(url) {
    const startTime = Date.now();
    try {
...
export async function handleInstagram(username) {
    const startTime = Date.now();
    try {
