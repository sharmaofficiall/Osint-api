import { validateAdminKey } from "./credits.js";
import { handleMediaFire, handleVehicleRC, handleGSTLookup, handlePhoneInfo, handleMACLookup, handleTeraBox, handleInstagram, getAllServices, } from "./handlers.js";
export default {
    async fetch(request, env, ctx) {
        ...
        if (path.startsWith("/api/admin")) {
            ...
            if (path === "/api/admin/sync-credits" && request.method === "POST") {
                try {
                    ...
                    return new Response(JSON.stringify({ success: true, message: `Synced ${users.length} users` }), { headers: { ...corsHeaders, "Content-Type": "application/json" } });
                }
                catch (error) {
                    return new Response(JSON.stringify({
                        success: false,
        ...
        if (path === "/api/mediafire") {
            ...
            if (!fileUrl) {
                return new Response(JSON.stringify({ success: false, error: "Missing 'url' parameter" }), { status: 400, headers: { ...corsHeaders, "Content-Type": "application/json" } });
            }
        ...
        if (path === "/api/vehicle") {
            ...
            if (!rc) {
                return new Response(JSON.stringify({ success: false, error: "Missing 'rc' parameter" }), { status: 400, headers: { ...corsHeaders, "Content-Type": "application/json" } });
            }
        ...
        if (path === "/api/gst") {
            ...
            if (!gstNumber) {
                return new Response(JSON.stringify({ success: false, error: "Missing 'gstNumber' parameter" }), { status: 400, headers: { ...corsHeaders, "Content-Type": "application/json" } });
            }
        ...
        if (path === "/api/phone") {
            ...
            if (!number) {
                return new Response(JSON.stringify({ success: false, error: "Missing 'number' parameter" }), { status: 400, headers: { ...corsHeaders, "Content-Type": "application/json" } });
            }
        ...
        if (path === "/api/mac") {
            ...
            if (!mac) {
                return new Response(JSON.stringify({ success: false, error: "Missing 'mac' parameter" }), { status: 400, headers: { ...corsHeaders, "Content-Type": "application/json" } });
            }
        ...
        if (path === "/api/instagram") {
            ...
            if (!username) {
                return new Response(JSON.stringify({ success: false, error: "Missing 'username' parameter" }), { status: 400, headers: { ...corsHeaders, "Content-Type": "application/json" } });
            }
